      ...
      <div className="hidden lg:block bg-primary-900 text-white">
        <div className="container-custom flex justify-between items-center py-2.5 text-sm">
          <div className="flex items-center gap-6">
            <a href="tel:+221770000000" className="flex items-center gap-2 hover:text-gold-400 transition-colors group">
              <Phone size={14} className="group-hover:animate-pulse" />
              <span>+221 77 000 00 00</span>
            </a>
            <a href="mailto:contact@gicos.sn" className="flex items-center gap-2 hover:text-gold-400 transition-colors">
              <Mail size={14} />
        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              <div className="w-11 h-11 lg:w-12 lg:h-12 bg-primary-700 rounded-xl flex items-center justify-center group-hover:bg-primary-800 transition-colors">
          ...
          <div className="container-custom py-4">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 space-y-3">
              <div className="flex items-center gap-3 px-4 text-sm text-gray-600">
                ...
                <a href="tel:+221770000000" className="hover:text-primary-700">+221 77 000 00 00</a>
              </div>
              <Link 
                to="/annonces" 
